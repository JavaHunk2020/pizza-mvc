...
public interface SQLQuery {
	...
	public static String INSERT_SIGNUP="insert into signup_tbl(username,password,email,name,salutation,datecreated,bphoto) values(?,?,?,?,?,?,?)";
	...
	public static String FIND_IMAGE_BY_ID="select bphoto from signup_tbl where sid=?";
